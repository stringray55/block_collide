...
import numpy as np
ar=np.array
#use this to create block sims
#vlc controls whether energy is lost or gained in collision. values of 0.7 to 1 seem to work pretty well, lower may run into errors.
